...
import '../LoginForm/LoginForm.css'; // Poți folosi același CSS ca pentru LoginForm sau să creezi unul nou
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setUsername('');
        setPassword('');
        // Redirecționează utilizatorul la pagina de login după 2 secunde
        setTimeout(() => {
          navigate('/login');
        }, 2000);
